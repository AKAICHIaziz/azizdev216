  ...
  return (
    <div className={styles.navbar}>
      ...
      <div className={styles.nav_links}>
        ...
        <div className={styles.nav_link}><a className={styles.a} href="#portfolio">Portfolio</a></div>
        <div className={styles.nav_link}><a className={styles.a} href="#contact">Contact</a></div>
      </div>
